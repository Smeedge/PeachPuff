...
namespace Project1
{
    class Bee
    {
        ...
        public void Update(GameTime gameTime)
        {
            ...
            float angle = (float)Math.Atan2(bat.Position.Y - locMatrix.Forward.Y, bat.Position.X - locMatrix.Forward.X);
            locMatrix = Matrix.CreateTranslation(location / 4);// *Matrix.CreateRotationY(angle); // * rotation code
